...
class _BottomChatTextFieldState extends ConsumerState<BottomChatTextField> {
  ...
  void _sendFile(File file, MessageTypes messageType) {
  ...
  void _pickAndSendImage(BuildContext context) async {
    ...
    if (imageFile != null) {
      _sendFile(imageFile, MessageTypes.image);
    }
  ...
  void _pickAndSendVideo(BuildContext context) async {
    ...
    if (videoFile != null) {
      _sendFile(videoFile, MessageTypes.video);
    }
  ...
  void _recordAndSendAudio() async {
    ...
    if (!_isAudioRecording) {
      ...
      _sendFile(File(audioFilePath), MessageTypes.audio);
    }
